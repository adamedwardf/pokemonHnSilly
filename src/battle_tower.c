...
const struct TrainerBallBF gTrainerBallTableBF[] = {
    ...
    {FACILITY_CLASS_FIREBREATHER, ITEM_POKE_BALL},
    ...
    //Below are added by Modern Emerald, they don't work in HnS
    //as the facility classes are not used.
    {FACILITY_CLASS_LEADER_BLUE, ITEM_PREMIER_BALL},
    {FACILITY_CLASS_RED, ITEM_PREMIER_BALL},
    {FACILITY_CLASS_LEAF, ITEM_PREMIER_BALL},
    {FACILITY_CLASS_CHAMPION_LANCE, ITEM_MASTER_BALL},
    {FACILITY_CLASS_CHAMPION_STEVEN, ITEM_MASTER_BALL},
    {FACILITY_CLASS_LEADER_BUGSY, ITEM_ULTRA_BALL},
    {FACILITY_CLASS_LEADER_JASMINE, ITEM_ULTRA_BALL},
    {FACILITY_CLASS_LEADER_ERIKA, ITEM_ULTRA_BALL},
    {FACILITY_CLASS_LEADER_PRYCE, ITEM_ULTRA_BALL},
    {FACILITY_CLASS_LEADER_BROCK, ITEM_ULTRA_BALL},
    {FACILITY_CLASS_LEADER_CHUCK, ITEM_ULTRA_BALL},
    {FACILITY_CLASS_LEADER_SABRINA, ITEM_ULTRA_BALL},
    {FACILITY_CLASS_LEADER_LT_SURGE, ITEM_ULTRA_BALL},
    {FACILITY_CLASS_LEADER_BLAINE, ITEM_ULTRA_BALL},
    {FACILITY_CLASS_LEADER_WHITNEY, ITEM_ULTRA_BALL},
    {FACILITY_CLASS_LEADER_FALKNER, ITEM_ULTRA_BALL},
    {FACILITY_CLASS_LEADER_JANINE, ITEM_ULTRA_BALL},
    {FACILITY_CLASS_LEADER_MISTY, ITEM_ULTRA_BALL},
    {FACILITY_CLASS_LEADER_MORTY, ITEM_ULTRA_BALL},
    {FACILITY_CLASS_LEADER_CLAIR, ITEM_ULTRA_BALL},
    {0xFF, ITEM_POKE_BALL},
};
...
const u8 gTowerMaleFacilityClasses[42] =
{
    ...
    FACILITY_CLASS_LEADER_FALKNER, //1
    FACILITY_CLASS_LEADER_BUGSY, //2
    FACILITY_CLASS_LEADER_MORTY, //4
    FACILITY_CLASS_LEADER_CHUCK, //5
    FACILITY_CLASS_LEADER_PRYCE, //7
    FACILITY_CLASS_LEADER_BROCK, //9
    FACILITY_CLASS_LEADER_LT_SURGE, //11
    FACILITY_CLASS_LEADER_BLAINE, //15
    FACILITY_CLASS_LEADER_BLUE, //16
    FACILITY_CLASS_RED, //new
    FACILITY_CLASS_CHAMPION_LANCE, //new
    FACILITY_CLASS_CHAMPION_STEVEN, //new
};

const u8 gTowerFemaleFacilityClasses[28] =
{
    ...
    FACILITY_CLASS_LASS,
    FACILITY_CLASS_LEADER_WHITNEY, //3
    FACILITY_CLASS_LEADER_JASMINE, //6
    FACILITY_CLASS_LEADER_CLAIR, //8
    FACILITY_CLASS_LEADER_MISTY, //10
    FACILITY_CLASS_LEADER_ERIKA, //12
    FACILITY_CLASS_LEADER_JANINE, //13
    FACILITY_CLASS_LEADER_SABRINA, //14
...
const u8 gTowerMaleTrainerGfxIds[42] =
{
    ...
    OBJ_EVENT_GFX_SWIMMER_LAND_M, //swimmer
    OBJ_EVENT_GFX_BLACK_BELT,
    OBJ_EVENT_GFX_ROCKER,
    OBJ_EVENT_GFX_FIREBREATHER, //kindler
    OBJ_EVENT_GFX_CAMPER,
    OBJ_EVENT_GFX_SUPER_NERD, //bug maniac
    OBJ_EVENT_GFX_PSYCHIC_M,
    OBJ_EVENT_GFX_GENTLEMAN,
    OBJ_EVENT_GFX_LITTLE_BOY_3, //school kid
    OBJ_EVENT_GFX_MAN, //pokefan
    OBJ_EVENT_GFX_OLD_MAN_1, //expert
    OBJ_EVENT_GFX_YOUNGSTER,
    OBJ_EVENT_GFX_FISHER,
    OBJ_EVENT_GFX_CYCLING_TRIATHLETE_M,  //cycling thriathlete
    OBJ_EVENT_GFX_COOLTRAINER_M, //running thriathlete
    OBJ_EVENT_GFX_SWIMMER_LAND_M, //swimming thriathlete
    OBJ_EVENT_GFX_COOLTRAINER_M, //dragon tamer
    OBJ_EVENT_GFX_ROCKER, //bird keeper
    OBJ_EVENT_GFX_NINJA_BOY, //ninja boy
    OBJ_EVENT_GFX_SAILOR,
    OBJ_EVENT_GFX_SUPER_NERD, //collector
    OBJ_EVENT_GFX_WORKER_M, //pkm breeder
    OBJ_EVENT_GFX_CAMPER, //pkm ranger
    OBJ_EVENT_GFX_BUG_CATCHER,
    OBJ_EVENT_GFX_HIKER,
    OBJ_EVENT_GFX_FALKNER, //1
    OBJ_EVENT_GFX_BUGSY, //2
    OBJ_EVENT_GFX_MORTY, //4
    OBJ_EVENT_GFX_BUGSY, //5
    OBJ_EVENT_GFX_PRYCE, //7
    OBJ_EVENT_GFX_BROCK, //9
    OBJ_EVENT_GFX_SURGE, //11
    OBJ_EVENT_GFX_BLAINE, //15
    OBJ_EVENT_GFX_BLUE, //16
    OBJ_EVENT_GFX_RED, //new
    OBJ_EVENT_GFX_LANCE, //new
...
const u8 gTowerFemaleTrainerGfxIds[28] =
{
    ...
    OBJ_EVENT_GFX_CHANNELER, //psychic F
    OBJ_EVENT_GFX_LITTLE_GIRL, //school kid F
    ...
    OBJ_EVENT_GFX_SWIMMER_LAND_F, //swimmer
    OBJ_EVENT_GFX_PICNICKER,
    OBJ_EVENT_GFX_WOMAN_2,
    OBJ_EVENT_GFX_PICNICKER,
    OBJ_EVENT_GFX_LASS,
    OBJ_EVENT_GFX_WHITNEY, //3
    OBJ_EVENT_GFX_JASMINE, //6
    OBJ_EVENT_GFX_CLAIR, //8
    OBJ_EVENT_GFX_MISTY, //10
    OBJ_EVENT_GFX_ERIKA, //12
    OBJ_EVENT_GFX_JANINE, //13
    OBJ_EVENT_GFX_SABRINA, //14
    OBJ_EVENT_GFX_LEAF, //new
};
...
{
    {RS_FACILITY_CLASS_AQUA_LEADER_ARCHIE, FACILITY_CLASS_LEADER_JASMINE},
    ...
    {RS_FACILITY_CLASS_KINDLER, FACILITY_CLASS_FIREBREATHER},
    ...
    {RS_FACILITY_CLASS_ELITE_FOUR_M, FACILITY_CLASS_LEADER_ERIKA},
    {RS_FACILITY_CLASS_ELITE_FOUR_F, FACILITY_CLASS_LEADER_PRYCE},
    {RS_FACILITY_CLASS_LEADER_F, FACILITY_CLASS_LEADER_BROCK},
    {RS_FACILITY_CLASS_LEADER_M, FACILITY_CLASS_LEADER_CHUCK},
    {RS_FACILITY_CLASS_LEADER_MF, FACILITY_CLASS_LEADER_SABRINA},
    ...
    {RS_FACILITY_CLASS_CHAMPION, FACILITY_CLASS_CHAMPION_LANCE},
    ...
    {RS_FACILITY_CLASS_LEADER_BLUE, FACILITY_CLASS_LEADER_BLUE},
    ...
    {RS_FACILITY_CLASS_MAGMA_LEADER, FACILITY_CLASS_LEADER_BUGSY},
...
} static const sPartnerTrainerTextTables[] =
{
    ...
    {FACILITY_CLASS_FIREBREATHER,          sPartnerTextsKindler},
...
void SetBattleFacilityTrainerGfxId(u16 trainerId, u8 tempVarId)
{
    ...
    case 0:
    default:
        VarSet(VAR_OBJ_GFX_ID_0, OBJ_EVENT_GFX_BOY);
        return;
    case 1:
        VarSet(VAR_OBJ_GFX_ID_1, OBJ_EVENT_GFX_BOY);
        return;
    case 15:
        VarSet(VAR_OBJ_GFX_ID_E, OBJ_EVENT_GFX_BOY);
        return;
    }
}
